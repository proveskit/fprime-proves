// ======================================================================
// \title  PROVESDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef PROVESDEPLOYMENT_PROVESDEPLOYMENTTOPOLOGY_HPP
#define PROVESDEPLOYMENT_PROVESDEPLOYMENTTOPOLOGY_HPP
// Included for access to PROVESDeployment::TopologyState and PROVESDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <PROVESDeployment/Top/PROVESDeploymentTopologyDefs.hpp>

// Remove unnecessary PROVESDeployment:: qualifications
using namespace PROVESDeployment;
namespace PROVESDeployment {
/**
 ...
 * PROVESDeployment::TopologyState see: PROVESDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type PROVESDeployment::TopologyState see: PROVESDeploymentTopologyDefs.hpp.
 *

...
#include <OreDeployment/Top/OreDeploymentTopology.hpp>
...
static void signalHandler(int signum) {
    OreDeployment::stopSimulatedCycle();
}
...
int main(int argc, char* argv[]) {
    ...
    OreDeployment::TopologyState inputs;
    ...
    OreDeployment::setupTopology(inputs);
    OreDeployment::startSimulatedCycle(Fw::Time(1, 0));  // Program loop cycling rate groups at 1Hz
    OreDeployment::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}

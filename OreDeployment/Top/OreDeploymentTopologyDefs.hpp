// ======================================================================
// \title  OreDeploymentTopologyDefs.hpp
// \brief required header file containing the required definitions for the topology autocoder
//
// ======================================================================
#ifndef OreDeployment_OreDeploymentTOPOLOGYDEFS_HPP
#define OreDeployment_OreDeploymentTOPOLOGYDEFS_HPP

#include "Drv/BlockDriver/BlockDriver.hpp"
#include "Fw/Types/MallocAllocator.hpp"
#include "OreDeployment/Top/FppConstantsAc.hpp"
 ...
 *
 * The topology autocoder requires an object that carries state with the name `OreDeployment::TopologyState`. Only the type

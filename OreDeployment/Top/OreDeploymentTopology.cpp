// ======================================================================
// \title  OreDeploymentTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <OreDeployment/Top/OreDeploymentTopologyAc.hpp>
#include <OreDeployment/Top/OreDeploymentPacketsAc.hpp>
...
void configureTopology() {
    ...
    // tlmSend.setPacketList(OreDeploymentPacketsPkts, OreDeploymentPacketsIgnore, 1);
...
// Public functions for use in main program are namespaced with deployment name OreDeployment
...
void setupTopology(const TopologyState& state) {
    ...
    hubComDriver.configure("0.0.0.0", 60000);
...
void startSimulatedCycle(Fw::Time interval) {
    ...
    // Main loop
    while (cycling) {
        OreDeployment::blockDrv.callIsr();

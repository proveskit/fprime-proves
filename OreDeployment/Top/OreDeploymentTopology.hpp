// ======================================================================
// \title  OreDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef OreDeployment_OreDeploymentTOPOLOGY_HPP
#define OreDeployment_OreDeploymentTOPOLOGY_HPP
// Included for access to OreDeployment::TopologyState and OreDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <OreDeployment/Top/OreDeploymentTopologyDefs.hpp>

// Remove unnecessary OreDeployment:: qualifications
using namespace OreDeployment;
namespace OreDeployment {
/**
 ...
 * OreDeployment::TopologyState see: OreDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type OreDeployment::TopologyState see: OreDeploymentTopologyDefs.hpp.
 *

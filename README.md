...
1. Run GDS over serial:
   ...
   ```sh
   fprime-gds -n --dictionary build-artifacts/rpipico/BroncoDeployment/dict/BroncoDeploymentTopologyAppDictionary.xml --communication-selection uart --uart-baud 115200 --uart-device /dev/ttyACM0 --output-unframed-data -
   ```

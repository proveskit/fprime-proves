...
static void signalHandler(int signum) {
    BroncoDeployment::stopSimulatedCycle();
}
...
int main(int argc, char* argv[]) {
    ...
    BroncoDeployment::startSimulatedCycle(Fw::Time(1, 0));  // Program loop cycling rate groups at 1Hz
    BroncoDeployment::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
